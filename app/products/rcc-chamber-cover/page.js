              ...
              <div className="animate-slide-in-right">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    High-quality RCC chamber covers designed for underground utility access. Provides secure and reliable access to inspection chambers with superior strength and durability.
                  </p>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our RCC Chamber Covers
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our RCC Chamber Covers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=RCC Chamber Cover"
