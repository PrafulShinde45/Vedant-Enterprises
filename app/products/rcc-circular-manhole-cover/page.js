          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our RCC Circular Manhole Covers
              </p>
            </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Circular Manholes</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <ul className="text-gray-600 space-y-3">
                  <li className="flex items-start">
                    ...
                    Circular design for perfect fit
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">•</span>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our RCC Circular Manhole Covers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=RCC Circular Manhole Cover"
