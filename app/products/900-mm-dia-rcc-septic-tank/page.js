...
export default function RCCSepticTank900mm() {
  const pricingData = [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="animate-slide-in-left">
                <div className="rounded-3xl overflow-hidden shadow-2xl hover-lift">
                  <img
                    src="/assets/st3-300x400.webp"
                    alt="900 MM Dia RCC Septic Tank"
              ...
              <div className="animate-slide-in-right">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Medium-sized 900mm diameter RCC septic tank suitable for residential and small commercial applications. Offers excellent durability and efficient wastewater management.
                  </p>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our 900 MM Dia RCC Septic Tank
              </p>
            </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Medium Residential</span>
                  </div>
                  <div className="flex justify-between">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our 900 MM Dia RCC Septic Tank.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=900 MM Dia RCC Septic Tank"
