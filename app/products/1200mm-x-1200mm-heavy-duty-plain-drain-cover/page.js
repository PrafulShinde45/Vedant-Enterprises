...
export default function HeavyDutyPlainDrainCover() {
  const pricingData = [
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="animate-slide-in-left">
                <div className="h-96 rounded-3xl overflow-hidden shadow-2xl hover-lift">
                  <img
                    src="/assets/manh2-300x400.webp"
                    alt="1200 MM X 1200 MM Heavy Duty Plain Drain Cover"
              ...
              <div className="animate-slide-in-right">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Heavy duty plain drain cover designed for high traffic areas. Features superior strength and durability for demanding drainage applications.
                  </p>
                  <div className="text-lg font-semibold text-green-600 mb-6">
                    Approx. Price: Rs 1,350 / Piece <span className="text-sm text-gray-500">(Get Latest Price)</span>
                  </div>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our Heavy Duty Plain Drain Cover
              </p>
            </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Plain</span>
                  </div>
                  <div className="flex justify-between">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our Heavy Duty Plain Drain Covers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=1200 MM X 1200 MM Heavy Duty Plain Drain Cover"
