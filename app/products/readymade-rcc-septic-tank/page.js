              ...
              <div className="animate-slide-in-right">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Pre-fabricated RCC septic tanks designed for efficient wastewater treatment. Available in multiple sizes for residential and commercial applications with superior durability and leak-proof construction.
                  </p>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our Readymade RCC Septic Tanks
              </p>
            </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Various Sizes</span>
                  </div>
                  <div className="flex justify-between">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our Readymade RCC Septic Tanks.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=Readymade RCC Septic Tank"
