...
export default function HeavyDutyPerforatedDrainCover() {
  const pricingData = [
    { size: '1200 MM X 1200 MM', price: 'Contact for Pricing' }
  ];
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="animate-slide-in-left">
                <div className="rounded-3xl overflow-hidden shadow-2xl hover-lift max-w-md mx-auto">
                  <img
                    src='/assets/manh3-150x150.webp'
                    alt="1200 MM X 1200 MM Heavy Duty Perforated Drain Cover"
              ...
              {/* Information */}
              <div className="animate-slide-in-right pt-[10%]">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  <h2 className="text-4xl font-bold text-gray-800 mb-6">
                    1200 MM X 1200 MM Heavy Duty Perforated Drain Cover
                  </h2>
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Heavy duty perforated drain cover designed for efficient water drainage. Features superior strength with perforations for optimal water flow in high traffic areas.
                  </p>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our Heavy Duty Perforated Drain Cover
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Heavy Duty Drainage</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">1200 MM X 1200 MM</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-700">Type:</span>
                    <span className="text-gray-600">Perforated</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <ul className="text-gray-600 space-y-3">
                  ...
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">•</span>
                    Perforated design for efficient drainage
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">•</span>
                    Corrosion resistant
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our Heavy Duty Perforated Drain Covers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=1200 MM X 1200 MM Heavy Duty Perforated Drain Cover"
