...
export default function ConcreteChamberCover() {
  const pricingData = [
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-gray-50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="animate-slide-in-left">
                <div className="rounded-3xl overflow-hidden shadow-2xl hover-lift">
                  <img
                    src="/assets/concrete-chamber-cover.webp"
                    alt="Concrete Chamber Cover"
              ...
              <div className="animate-slide-in-right">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Durable concrete chamber covers designed for underground utility access. Provides secure and reliable access to inspection chambers and utility boxes.
                  </p>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our Concrete Chamber Covers
              </p>
            </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Square/Rectangular</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Medium Duty</span>
                  </div>
                  <div className="flex justify-between">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              <h2 className="text-3xl font-bold text-gray-800 mb-4">Related Chamber Cover Products</h2>
              <p className="text-lg text-gray-600">
                Explore other chamber cover options from our collection
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our Concrete Chamber Covers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=Concrete Chamber Cover"
