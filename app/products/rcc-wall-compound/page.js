              ...
              <div className="animate-slide-in-right">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Durable RCC compound walls designed for boundary demarcation and security. Available in standard and custom sizes with reinforced concrete construction for maximum strength and longevity.
                  </p>
                  ...
                  <div className="bg-gradient-to-r from-green-100 to-blue-100 px-4 py-2 rounded-lg inline-block">
                    <span className="font-semibold text-gray-700">CATEGORY: RCC WALL COMPOUND</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our RCC Wall Compound
              </p>
            </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Rectangular/Panel</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Various Heights</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Standard Thickness</span>
                  </div>
                  <div className="flex justify-between">
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our RCC Wall Compound.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=RCC Wall Compound"
