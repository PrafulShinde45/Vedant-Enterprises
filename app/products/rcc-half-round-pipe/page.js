...
export default function RCCHalfRoundPipe() {
  const relatedProducts = [
    ...
    {
      name: '300 MM Cement Pipe',
      image: '/assets/300mm-cement-pipe.webp',
      link: '/products/300-mm-cement-pipe'
    },
    {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="animate-slide-in-left">
                <div className="rounded-3xl overflow-hidden shadow-2xl hover-lift">
                  <img
                    src="/assets/half-round-pipe-300x400.webp"
                    alt="RCC Half Round Pipe"
              ...
              <div className="animate-slide-in-right">
                <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed mb-6">
                    Premium quality RCC half round pipes designed for specific drainage and irrigation applications. These pipes provide excellent strength and durability for half-section installations.
                  </p>
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-16">
            <div className="text-center mb-12 animate-fade-in-up">
              ...
              <p className="text-lg text-gray-600">
                Detailed specifications and features of our RCC Half Round Pipes
              </p>
            </div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Half Round</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Drainage & Irrigation</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-600">Half Round Pipe</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <ul className="text-gray-600 space-y-3">
                  <li className="flex items-start">
                    ...
                    Half round design for specific applications
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">•</span>
                    High strength RCC construction
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-600 mr-2">•</span>
                    Corrosion resistant
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 md:px-16 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Contact us for pricing, custom orders, or any questions about our RCC Half Round Pipes.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact?product=RCC Half Round Pipe"
