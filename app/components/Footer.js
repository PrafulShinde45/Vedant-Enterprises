  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a href="https://wa.me/919881346886" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 animate-float hover:scale-110 inline-block">
            ...
            <div className="glassmorphism p-6 animate-stagger-3 hover-lift">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 group">
                  ...
                  <span className="text-sm">+91 98813 46886</span>
                </div>
                <div className="flex items-center space-x-3 group">
            ...
            <div className="glassmorphism p-6 animate-stagger-4 hover-lift">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 px-3 py-3 text-white placeholder-white border border-white/30 rounded-md sm:rounded-l-lg sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-green-300 transition-all duration-300 bg-transparent disabled:opacity-50"
                />
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 px-4 py-3 rounded-md sm:rounded-r-lg sm:rounded-l-none transition-all duration-300 hover:scale-105 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
